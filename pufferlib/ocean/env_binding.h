...
PyMODINIT_FUNC PyInit_binding(void) {
    ...
    PyModule_AddIntConstant(m, "CONTROLLER_RANDOM", CONTROLLER_RANDOM);
    ...
    PyModule_AddIntConstant(m, "TARGET_INFRACTION_BEHAVIOR_NORMAL", TARGET_INFRACTION_BEHAVIOR_NORMAL);
    PyModule_AddIntConstant(m, "TARGET_INFRACTION_BEHAVIOR_IGNORE", TARGET_INFRACTION_BEHAVIOR_IGNORE);
    PyModule_AddIntConstant(m, "TARGET_INFRACTION_BEHAVIOR_REMOVE", TARGET_INFRACTION_BEHAVIOR_REMOVE);
    PyModule_AddIntConstant(m, "ADVERSARIAL_TERMINATION_MODE_DISABLED", ADVERSARIAL_TERMINATION_MODE_DISABLED);
    PyModule_AddIntConstant(
        m,
        "ADVERSARIAL_TERMINATION_MODE_ALL_ADVERSARIES_INACTIVE",
        ADVERSARIAL_TERMINATION_MODE_ALL_ADVERSARIES_INACTIVE);
    PyModule_AddIntConstant(
        m,
        "ADVERSARIAL_TERMINATION_MODE_TARGET_INACTIVE",
        ADVERSARIAL_TERMINATION_MODE_TARGET_INACTIVE);
    PyModule_AddIntConstant(m, "ADVERSARIAL_TERMINATION_MODE_EITHER", ADVERSARIAL_TERMINATION_MODE_EITHER);
    PyModule_AddIntConstant(
        m,
        "ADVERSARIAL_TERMINATION_MODE_NO_NEARBY_ADVERSARY",
        ADVERSARIAL_TERMINATION_MODE_NO_NEARBY_ADVERSARY);
    PyModule_AddIntConstant(
        m,
        "ADVERSARIAL_TERMINATION_MODE_TARGET_INACTIVE_OR_NO_NEARBY_ADVERSARY",
        ADVERSARIAL_TERMINATION_MODE_TARGET_INACTIVE_OR_NO_NEARBY_ADVERSARY);
    PyModule_AddIntConstant(m, "GIGAFLOW_SPAWN_MODE_UNIFORM", GIGAFLOW_SPAWN_MODE_UNIFORM);
    PyModule_AddIntConstant(m, "GIGAFLOW_SPAWN_MODE_TARGETED", GIGAFLOW_SPAWN_MODE_TARGETED);
    PyModule_AddIntConstant(m, "SPAWN_SPEED_MODE_FIXED", SPAWN_SPEED_MODE_FIXED);
    PyModule_AddIntConstant(m, "SPAWN_SPEED_MODE_RANDOM", SPAWN_SPEED_MODE_RANDOM);
    PyModule_AddIntConstant(m, "EVAL_AGENT_COUNT_MODE_FIXED", EVAL_AGENT_COUNT_MODE_FIXED);
    PyModule_AddIntConstant(m, "EVAL_AGENT_COUNT_MODE_RANDOM", EVAL_AGENT_COUNT_MODE_RANDOM);
    PyModule_AddIntConstant(m, "TARGET_FAILURE_EPISODE_END_TERMINATED", TARGET_FAILURE_EPISODE_END_TERMINATED);
    PyModule_AddIntConstant(m, "TARGET_FAILURE_EPISODE_END_TRUNCATED", TARGET_FAILURE_EPISODE_END_TRUNCATED);
