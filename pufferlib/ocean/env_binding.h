...
PyMODINIT_FUNC PyInit_binding(void) {
    ...
    PyModule_AddIntConstant(m, "IGNORE_INFRACTION", IGNORE_INFRACTION);
    PyModule_AddIntConstant(m, "STOP_AGENT", STOP_AGENT);
    PyModule_AddIntConstant(m, "REMOVE_AGENT", REMOVE_AGENT);
