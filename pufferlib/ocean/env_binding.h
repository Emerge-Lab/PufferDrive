...
PyMODINIT_FUNC PyInit_binding(void) {
    ...
    PyModule_AddIntConstant(
        ...
        ADVERSARIAL_TERMINATION_MODE_TARGET_INACTIVE_OR_NO_NEARBY_ADVERSARY);
    PyModule_AddIntConstant(m, "GIGAFLOW_SPAWN_MODE_GLOBAL", GIGAFLOW_SPAWN_MODE_GLOBAL);
    PyModule_AddIntConstant(m, "GIGAFLOW_SPAWN_MODE_TARGET_PROXIMITY", GIGAFLOW_SPAWN_MODE_TARGET_PROXIMITY);
