...
struct Agent {
    ...
    float goal_gt_x;       // Last valid ground-truth goal position x
    float goal_gt_y;       // Last valid ground-truth goal position y
    float goal_gt_z;       // Last valid ground-truth goal position z
