...
int eval_gif(const char *map_name, const char *policy_name, int show_grid, int obs_only, int lasers,
    ...
    Drive env = {
        ...
        .adv_target_failure_reward = conf.adv_target_failure_reward,
        .adv_target_avoidability_reward = conf.adv_target_avoidability_reward,
        .adv_target_detection_reward = conf.adv_target_detection_reward,
        .adv_target_time_reward_tau = conf.adv_target_time_reward_tau,
