...
void demo() {
    ...
    Drive env = {
        ...
        .stop_sign_behavior = conf.stop_sign_behavior,
        ...
        .traffic_lights_enabled = conf.traffic_lights_enabled,
        .stop_signs_enabled = conf.stop_signs_enabled,
        .yield_signs_enabled = conf.yield_signs_enabled,
