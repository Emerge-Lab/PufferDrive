...
#define REGENTS_BRAKING_ACCELERATION_METERS_PER_SECOND_SQUARED 5.0f
#define REGENTS_FORWARD_ACCELERATION_METERS_PER_SECOND_SQUARED 4.0f
#define REGENTS_STEERING_RATE_LIMIT_RADIANS_PER_SECOND 1.0f
...
#define COLLISION_CONTACT_SCAN_STEPS 32
#define COLLISION_CONTACT_BINARY_SEARCH_STEPS 18

// Target collision avoidability
#define TARGET_TRAJECTORY_HISTORY_LEN 80
#define COMPLIANCE_HISTORY_LEN TARGET_TRAJECTORY_HISTORY_LEN
#define COMPLIANCE_WINDOW_SECONDS 5.0f
#define COMPLIANCE_WRONG_WAY_DISTANCE_THRESHOLD_METERS 2.0f
#define COMPLIANCE_SPEED_LIMIT_RATIO_THRESHOLD 1.05f
#define COMPLIANCE_FLAG_RED_LIGHT (1u << 0)
#define COMPLIANCE_FLAG_SOLID_LINE (1u << 1)
#define COMPLIANCE_FLAG_LANE_AVAILABLE (1u << 2)
#define COMPLIANCE_FLAG_SPEED_LIMIT_AVAILABLE (1u << 3)
#define TARGET_AVOIDABILITY_BRAKE_DECEL_MPS2 5.0f
#define TARGET_AVOIDABILITY_REACTION_TIME_SECONDS 1.0f
#define TARGET_REACTION_WINDOW_HALF_WIDTH_SECONDS 0.2f
#define TARGET_AVOIDABILITY_MAX_BRAKE_STEPS 81
#define TARGET_AVOIDABILITY_MAX_ROLLOUT_STEPS (TARGET_TRAJECTORY_HISTORY_LEN + TARGET_AVOIDABILITY_MAX_BRAKE_STEPS)
// Adversaries the braking counterfactual walks per rollout step. Bounds both populations
// is_adversarial_agent accepts: active agents and ReGentS-injected replay agents.
#define MAX_AVOIDABILITY_ADVERSARIES 256
#define AVOIDABILITY_DEBUG_MAX_CANDIDATES TARGET_TRAJECTORY_HISTORY_LEN
#define AVOIDABILITY_DEBUG_MAX_DETECTION_SAMPLES TARGET_TRAJECTORY_HISTORY_LEN
#define NO_AVOIDABLE_BRAKING_TIME_SECONDS (-1.0f)
#define AVOIDABLE_BRAKING_TIME_UNSET_SECONDS (-2.0f)
