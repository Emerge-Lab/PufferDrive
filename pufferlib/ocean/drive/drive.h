...
// Predicted action trajectory length (must match Python policy)
#define PREDICTED_TRAJ_LEN 12
...
struct Drive {
    ...
    float *predicted_traj_x; // [active_agent_count * PREDICTED_TRAJ_LEN], set via binding
    float *predicted_traj_y; // [active_agent_count * PREDICTED_TRAJ_LEN], set via binding
};
...
// Forward-simulate agent from its current state using a sequence of predicted actions.
