...
<body>
    ...
    <script>
        ...
        function colorFor(id, control_state, stopped) { return stopped ? "red" : (control_state === 0 ? VEHICLE_COLORS[Math.abs(id) % VEHICLE_COLORS.length] : (control_state === 1 ? "#bfbfbf" : "#404040")); }
