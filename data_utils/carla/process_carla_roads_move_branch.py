...
if __name__ == "__main__":
    ...
    source_dir = "data_utils/carla/carla_py123d"
    ...
    print_number_of_sample_truncations = True  # Enable to see the number of data points lost due to truncation of poly-lines
