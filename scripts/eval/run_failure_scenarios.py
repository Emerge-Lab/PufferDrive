...
BASE_COMMAND_PREFIX = "puffer eval puffer_drive --eval_simulation replay --load-model-path experiments/puffer_drive_0jb42gn1/best_models/model_puffer_drive_000700.pt --num_scenarios 500 --render 1 --render-backend obs_html"
