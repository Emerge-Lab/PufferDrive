...
#SBATCH --mem=1007G
#SBATCH --time 2-00:00
#SBATCH --output /home/bjaeger/PufferDrive/experiments/k_nightly_0002/log_%a_%A.out
#SBATCH --error /home/bjaeger/PufferDrive/experiments/k_nightly_0002/log_%a_%A.err
...
export RUN_NAME=k_nightly_0002
echo ${RUN_NAME}
