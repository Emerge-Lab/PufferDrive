...
#SBATCH --mem=1007G
#SBATCH --time 3-00:00
#SBATCH --output /home/bjaeger/PufferDrive/experiments/k_scaled_0001/log_%a_%A.out
#SBATCH --error /home/bjaeger/PufferDrive/experiments/k_scaled_0001/log_%a_%A.err
