...
#SBATCH --output /home/bjaeger/PufferDrive/experiments/k_fast_0000/log_%a_%A.out
#SBATCH --error /home/bjaeger/PufferDrive/experiments/k_fast_0000/log_%a_%A.err
