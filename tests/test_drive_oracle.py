...
def test_oracle_mode():
    ...
    for i in range(num_agents):
        ...
        oracle_obs_i = obs[i, oracle_start:oracle_start + oracle_dims].reshape(64, conditioning_dims)
        ...
        for j in range(num_agents):
            if i == j:
                continue
            oracle_obs_j = obs[j, oracle_start:oracle_start + oracle_dims].reshape(64, conditioning_dims)
